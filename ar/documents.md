...
layout: default
title: المستندات
permalink: /ar/documents/
lang: ar
translation_key: documents
---

<section class="pt-14 pb-10 md:pt-32 md:pb-20 text-center">
  <h1 class="text-4xl text-cyan-400 mb-6">المستندات</h1>
  <p class="text-gray-400">أوراق بيضاء وسياسات وتراخيص ووثائق قانونية.</p>
</section>
...
<section class="max-w-6xl mx-auto px-4 pb-8" data-docs-filter>
  <div class="overflow-x-auto">
    <div class="flex min-w-max items-center gap-2 rounded-xl p-2 bg-slate-900/45 ring-1 ring-cyan-400/20 backdrop-blur-md shadow-[0_0_30px_rgba(34,211,238,0.14)]">
      ...
      <button type="button" class="doc-filter-button px-4 py-2 text-xs sm:text-sm uppercase tracking-[0.08em] rounded-md text-slate-300 hover:text-cyan-200 hover:bg-white/5" data-filter="legal">🏷️ قانوني</button>
      <button type="button" class="doc-filter-button px-4 py-2 text-xs sm:text-sm uppercase tracking-[0.08em] rounded-md text-slate-300 hover:text-cyan-200 hover:bg-white/5" data-filter="certificates">🏆 شهاداتي</button>
    </div>
  </div>
...
<section class="max-w-6xl mx-auto px-4 pb-20 space-y-14">
  <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-8 gap-y-10">
    ...
    <article class="doc-filter-item doc-card rounded-xl flex flex-col gap-4" data-doc-category="policy">
      <h3 class="doc-title text-xl font-semibold text-slate-100 leading-tight">سياسة الخصوصية — Shadow Archive</h3>
      <p class="text-xs text-slate-400 font-[Noto_Sans_Arabic,sans-serif]">سياسة خصوصية لعبة Shadow Archive</p>
      <div class="border-t border-slate-700/60 pt-3">
        <div class="flex items-center gap-3 text-sm font-mono text-slate-300">
          <a href="{{ site.baseurl }}/privacy-policy/tenArhivaru/TenArhivaRu.pdf" class="doc-link transition">PDF</a>
          <a href="{{ site.baseurl }}/privacy-policy/tenArhivaru/privacy-policy-tenArhiva-ar.html" class="doc-link transition">HTML</a>
        </div>
      </div>
    </article>
    ...
    <!-- License RU -->
    <article class="doc-filter-item doc-card rounded-xl flex flex-col gap-4" data-doc-category="licenses">
      <h3 class="doc-title text-xl font-semibold text-slate-100 leading-tight">الترخيص — Русский</h3>
    ...
    <!-- Trademarks RU -->
    <article class="doc-filter-item doc-card rounded-xl flex flex-col gap-4" data-doc-category="legal">
      <h3 class="doc-title text-xl font-semibold text-slate-100 leading-tight">العلامات التجارية — Русский</h3>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var descriptions = {
      ...
      whitepaper: {
        ...
        focus:    'النطاق، الملكية، وقواعد إجراء تدقيق الأمن السيبراني.'
      },
      policy: {
        title:    'السياسة',
        audience: 'لأصحاب المصلحة وفرق الامتثال.',
        focus:    'سياسة الخصوصية: معالجة البيانات والاحتفاظ بها وحقوق المستخدم.'
      },
      licenses: {
        title:    'التراخيص',
        audience: 'لأي شخص يستخدم أو يعيد توزيع مواد المشروع.',
        focus:    'CC BY‑NC 4.0 — شروط استخدام التقارير والقوالب والوثائق.'
      },
      legal: {
        title:    'قانوني',
        audience: 'للشركاء ووسائل الإعلام والأطراف الثالثة.',
        focus:    'إشعارات العلامات التجارية وإرشادات استخدام علامة DataDef.'
      },
      certificates: {
        title:    'شهاداتي',
        audience: 'المؤهلات والشهادات المهنية المعتمدة.',
        focus:    'شهادات معترف بها في مجال الأمن السيبراني وأمن المعلومات.'
      }
    };
