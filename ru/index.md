...
<section class="h-screen flex items-center justify-center relative overflow-hidden">
  ...
  <div class="text-center z-10" data-aos="fade-up">
    ...
    <div class="flex justify-center gap-4">
      <a href="/ru/reports/" class="px-6 py-3 bg-cyan-500 text-black font-bold hover:bg-cyan-400 transition">
        Смотреть отчеты
      </a>

      <a href="/ru/lab/" class="px-6 py-3 border border-red-500 text-red-400 hover:bg-red-500 hover:text-black transition">
        Открыть лабораторию
      </a>
    </div>
