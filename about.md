...
<section class="pt-32 pb-20 text-center">
  <h1 class="text-4xl text-cyan-400 mb-6">About</h1>
  <p class="text-gray-400">Security specialist focused on penetration testing and infrastructure defense.</p>
</section>
...
<section class="max-w-6xl mx-auto px-4 pb-20">
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8">
    <article class="about-filter-item about-card rounded-xl flex flex-col gap-4" data-about-category="page">
      <h3 class="about-title text-xl font-semibold text-slate-100 leading-tight">About this page</h3>
    ...
    <article class="about-filter-item about-card rounded-xl flex flex-col gap-4" data-about-category="me">
      <h3 class="about-title text-xl font-semibold text-slate-100 leading-tight">About me</h3>
      <p class="text-sm text-slate-400">Short professional profile, focus areas, and security background.</p>
    </article>
  </div>
</section>
